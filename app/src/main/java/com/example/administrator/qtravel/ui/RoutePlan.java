...
import com.example.administrator.qtravel.adapter.RouteLineAdapter;
import com.example.administrator.qtravel.overlayutil.BikingRouteOverlay;
import com.example.administrator.qtravel.overlayutil.DrivingRouteOverlay;
import com.example.administrator.qtravel.overlayutil.MassTransitRouteOverlay;
import com.example.administrator.qtravel.overlayutil.OverlayManager;
import com.example.administrator.qtravel.overlayutil.TransitRouteOverlay;
import com.example.administrator.qtravel.overlayutil.WalkingRouteOverlay;
...
public class RoutePlan extends Activity implements BaiduMap.OnMapClickListener,
    ...
    String city = "张家界";
    String startNodeStr = "老地方私房菜";
    String endNodeStr = "虎穴公园";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //接收locationActivity传来的地点列表
        Intent intent = getIntent();
        poiList = intent.getStringArrayListExtra("poiList");
        startNodeStr = poiList.get(0);
        endNodeStr = poiList.get(1);
        Log.d("k", "onCreate: "+poiList.get(0));
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (adapterView.getSelectedItem()+""){
                    case "驾车":
//                        Toast.makeText(RoutePlan.this, adapterView.getSelectedItem()+"", Toast.LENGTH_SHORT).show();
